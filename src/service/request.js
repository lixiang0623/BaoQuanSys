...
/*
    ...
    headers - 通过原生方法获取
*/
export async function sendRequest({ requestData, operationType, message }) {
    const { getHeader, getAppConfig, showLoading, hideLoading } = utilities;
...
/*
    发送请求通过 mpass内置 rpc
*/
export function sendRequestByRpc({ requestData, operationType, message }) {
    message && showLoading(message)
    return new Promise((resolve, reject) => {
        AlipayJSBridge.call('rpc', {
            operationType,
